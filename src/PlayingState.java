  ...
  battle.play();
	...
	tyuui=0;
		...
		if(event.charAt(0) == ' '){
			...
			if(yourAnswer.equals(teki.getQuestion())){
				 if((gunFlag==2 && teki.getDirection() <= 2) ||(gunFlag ==1 && teki.getDirection() > 2)){
						tyuui=1;
						tyuuitime=0;
					}
	...
	public void paint(Graphics g) {
		    ...
		    //あなたの描画HPとか
		       ...
		       if(aristime>13){
		          ...
		          switch(drawflag){
		          case 1:g.drawImage(zyu1, 470, 270, model.getView());
		          break;
		          case 2:g.drawImage(zyu2, 470, 270, model.getView());
		          break;
		          case 3:g.drawImage(zyu3, 470, 270, model.getView());
		          break;
		          case 4:g.drawImage(zyu4, 470, 270, model.getView());
		          break;
		          case 5: 
		          break;
		          default:
